...
const messages = {
  ...
  YOUTUBE_NAME: "Better Youtube",
  YOUTUBE_DESCRIPTION: "Adds a optional adblock and a optional setting to disable the restricted content",
  ...
  GHOST_CALL_NAME: "Ghost Call",
  GHOST_CALL_DESCRIPTION: "Allows you to cancel the calling sound",
